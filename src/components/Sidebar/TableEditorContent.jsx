  ...
  <div className="h-full">
    ...
    <div className="space-y-3 px-5 pt-4 ">
      <div className="space-y-3 mb-11">
        <div className="bg-secondary rounded-md px-2 py-0.5 flex items-center border border-tertiary">
          <span className="text-gray-300">Scheme</span>
          <span className="text-white ml-2 font-medium">public</span>
        </div>

        <button className="bg-secondary rounded-md px-2 py-0.5 w-full flex items-center text-white border border-tertiary">
