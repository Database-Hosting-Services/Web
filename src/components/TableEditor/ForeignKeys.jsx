...
const ForeignKeys = () => {
  return (
    <div className="mb-8">
      ...
      <div className="border border-dashed border-tertiary rounded-md p-3 flex justify-center">
        <button className="text-gray-400 text-sm">Add foreign key relation</button>
      </div>
    </div>
  );
};
