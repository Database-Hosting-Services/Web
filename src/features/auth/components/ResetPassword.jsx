      ...
      <div className="bg-[#191A30] p-6 sm:p-8 border border-[#282939] rounded-3xl w-lvh h-2/7">
        ...
        <form className="flex flex-col items-center">
          ...
          <input
            type="email"
            name="email"
            className="bg-secondary [box-shadow:0_0_1000px_1000px#191A30_inset] mb-1 p-6 border border-tertiary rounded-3xl focus:outline-none w-[500px] h-[50px] text-text autofill:text-text transition-all duration-300"
          />
          <button
            type="submit"
